function [lgr,data] = l_proportional_integral(input, output, sam_freq, InitialState, InitialParameters)
...
%% Model Definition
FileName = 'l_proportional_integral_model';

if (predict_flag)
    Parameters = {'Kp',InitialParameters(1);'Ki',InitialParameters(2)};
else
    Parameters = {'Kp',1;'Ki',1};   
end
